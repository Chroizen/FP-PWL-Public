        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
          <ul class="navbar-nav me-auto mb-2 mb-md-0">
            ...
            <li class="nav-item <?php if ($_GET['cust'] == 'jobs') {
              ...
              <a class="nav-link" href="./home_cust.php?cust=jobs">Jobs</a>
            </li>

            <li class="nav-item <?php if ($_GET['cust'] == 'cart') {
                                  echo "active";
                                } ?>">
              <a class="nav-link" href="./home_cust.php?cust=cart">
                <i class='bx bx-shopping-bag'></i>Keranjang
                <?php
