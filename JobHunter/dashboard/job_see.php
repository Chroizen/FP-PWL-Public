      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
          <ul class="navbar-nav me-auto mb-2 mb-md-0">
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="home_cust.php">Home</a>
            </li>
            ...
            <li class="nav-item <?php if ($_GET['cust'] == 'jobs') {
                                  echo "active";
                                } ?>">
          ...
          <div class="row">
            <div class="col-lg-8 mx-auto">
              ...
              <ul class="list-group shadow">
                ...
                $query = mysqli_query($koneksi, "SELECT * FROM jobs WHERE idJob='$idJob'");
                $array = mysqli_fetch_array($query);

                $q_job = mysqli_query($koneksi, "SELECT * FROM review WHERE idJob='$idJob'");
                $arrq_job = mysqli_num_rows($q_job);

                echo $idJob;
                echo $idJob . "<li class='list-group-item'>
                    <!-- Custom content-->
                    <div class='media align-items-lg-center flex-column flex-lg-row p-3'>
                        <div class='media-body order-2 order-lg-1'>
                            <h5 class='mt-0 font-weight-bold mb-2'>" . $array['nama_job'] . "</h5>
